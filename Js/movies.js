...
fetch("https://asmaamaged2022.github.io/MovixaAPI/Movies_All.json")
  ...
  .then((data) => {
    ...
    moviePage.innerHTML = `   <div class="image w-100">
      ...
      <div class="container">
       ...
       <button  onclick="goHome()" class="mainbtn py-1 px-4 mb-5 mx-auto"><span class="me-2">Back Home</span><img src="./Icon/left-arrow.gif" alt="" /></button>
      `;
  });
function goHome() {
